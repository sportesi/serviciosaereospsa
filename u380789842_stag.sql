...
--
-- Servidor: localhost
-- Tiempo de generación: 08-08-2016 a las 19:06:28
...
(1, 'admin', 'admin', 'sebastian@proyectiva.com', 'sebastian@proyectiva.com', 1, 'l7q895l85ts04s040gsoc8gocsg0g8g', '$2y$13$Q7fgWMJ6IhVxwwI7LqeYpOzASJdDMIBSudV7lo3xooVEFV7R4WAFm', '2016-08-06 21:38:17', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:10:"ROLE_ADMIN";}', 0, NULL),
...
CREATE TABLE IF NOT EXISTS `turno` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_E7976762C5A188EC` (`id_fos_user`),
  KEY `IDX_E7976762CDC8DC08` (`id_avion`),
  KEY `IDX_E7976762A0B1D394` (`id_dia`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `turno`
  ADD CONSTRAINT `FK_E7976762A0B1D394` FOREIGN KEY (`id_dia`) REFERENCES `dia` (`id`),
  ADD CONSTRAINT `FK_E7976762C5A188EC` FOREIGN KEY (`id_fos_user`) REFERENCES `fos_user` (`id`),
